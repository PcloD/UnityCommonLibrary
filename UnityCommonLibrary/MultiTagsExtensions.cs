...
namespace UnityCommonLibrary
{
    public static class MultiTagsExtensions
    {
        ...
        public static bool HasAnyTags<T>(this GameObject obj, T mask)
            where T : struct, IFormattable, IConvertible, IComparable
        {
        ...
        public static void AddTags<T>(this Component cmp, T mask)
            where T : struct, IFormattable, IConvertible, IComparable
        {
            MultiTags<T>.AddTags(cmp, mask);
        }

        public static void AddTags<T>(this GameObject obj, T mask)
            where T : struct, IFormattable, IConvertible, IComparable
        {
        ...
        public static bool TagsMatch<T>(this Component cmp, GameObject other)
            where T : struct, IFormattable, IConvertible, IComparable
        {
            return MultiTags<T>.TagsMatch(cmp, other);
        }

        public static bool TagsMatch<T>(this GameObject obj, Component other)
            where T : struct, IFormattable, IConvertible, IComparable
        {
        ...
        public static bool SharesAny<T>(this Component cmp, GameObject other)
            where T : struct, IFormattable, IConvertible, IComparable
        {
            return MultiTags<T>.SharesAny(cmp, other);
        }
        ...
        public static bool SharesTag<T>(this Component cmp, GameObject other, T tag)
            where T : struct, IFormattable, IConvertible, IComparable
        {
            return MultiTags<T>.SharesTag(cmp, other, tag);
        }

        public static bool SharesTag<T>(this GameObject obj, Component other, T tag)
            where T : struct, IFormattable, IConvertible, IComparable
        {
